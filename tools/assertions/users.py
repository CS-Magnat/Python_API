...
def assert_create_user_response(request: CreateUserRequestSchema, response: CreateUserResponseSchema):
    """
    Checks that user creation response matches request
...
def assert_get_user_response(get_user_response: GetUserResponseSchema, create_user_response: CreateUserResponseSchema):
    """
    Checks that get user response matches user creation response

    :param get_user_response: API response when requesting user data
    :param create_user_response: API response when creating user
    :raises AssertionError: If user data doesn't match
    """
