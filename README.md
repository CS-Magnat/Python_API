...
the [API Test Server](https://github.com/CS-Magnat/Python_API). The
tests are written using **Python**, **Pytest**, **Allure**, **Pydantic**, **Faker** and **HTTPX**. The test
application’s source code is available on [GitHub](https://github.com/CS-Magnat/Python_API).
...
```bash
git clone https://github.com/CS-Magnat/Python_API.git
cd Python_API
```
